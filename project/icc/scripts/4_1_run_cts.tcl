...
#reference: http://bbs.eetop.cn/viewthread.php?tid=481736 SunYongshuai
...
report_constraint -all
redirect -tee $reports_path/cts_only_cts.timing { report_timing }   
#Area  idct_chip                    0.00       1037046.50     -1037046.50  (VIOLATED)
...
redirect -tee $reports_path/cts_only_psyn.timing { report_timing }
report_qor
report_constraint -all
