source 5_2_common_optimization_settings_icc.tcl
source 5_3_common_placement_settings.tcl
source 5_4_common_post_cts_timing_settings.tcl
source 5_5_common_route_si_settings_zrt_icc.tcl
...
redirect -tee $reports_path/route_initial.timing { report_timing }
report_clock_tree -summary
report_clock_timing -type skew
report_qor
report_constraint -all

route_opt -skip_initial_route  -power -effort high
redirect -tee $reports_path/route_power.timing { report_timing }
source 5_6_derive_pg.tcl
