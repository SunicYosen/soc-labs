source $script_path/8_1_ant.tcl
...
verify_zrt_route 
verify_lvs -max_error 1000 > $reports_path/lvs_violations.rpt
verify_drc > $reports_path/drc.rpt
report_constraint -all_violators -nosplit -significant_digits 4 > $reports_path/violations.rpt
check_timing
